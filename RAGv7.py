...
################## initial ##############
    def __init__(self, root):
        self.torch = torch
        self.root = root
        self.root.title("高级PDF RAG系统 v7 (Ollama,lm studio)")
    ...
    def creat_embedding_model(self):
        """创建嵌入模型"""
...
#################### process PDF files #########################
    ...
    def process_pdfs(self, folder):
        ...
        try: 
            ...
            for root, _, files in os.walk(folder):
                result = self._process_added_pdfs(files, True)
    ...
    def _process_added_pdfs(self, files, folder=False ):
        """实际处理新增多个PDF文件的逻辑"""
        try:
            added_count = 0
            skipped_count = 0
...
################################ vector store ######################
    ...
    def load_vectorstore(self, path="vectorstore"):
        ...
        try:
            ...
            print(f"文档条数：:{self.vectorstore.index_to_docstore_id}")
